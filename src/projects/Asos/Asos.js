    ...
    return (
        <div className="project-page-container" >
            <div className="project-page-content fade" ref={containerRef}>
                        ...
                        <div className="pp-hero-bottom">
                            <div className="pp-overview-container">
                                ...
                                <p className="project-overview-text">
                                    I redesigned internationally renowned
                                    clothing brand ASOS's website
                                </p>
                            </div>
                ...
                <img src={homedisplay} alt="" className="pp-img-full display" />
                ...
                <img src={productsdisplay} alt="" className="pp-img-full display" />
